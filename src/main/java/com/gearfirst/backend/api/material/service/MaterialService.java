...
public class MaterialService {
    ...
    public Page<CompanyResponse> getCompanyList(String keyword, Boolean isSelected, Pageable pageable) {
        // 1. Specification 클래스를 호출하여 동적 쿼리를 생성합니다.
        Specification<CompanyEntity> spec = CompanySpecification.build(keyword, isSelected);
